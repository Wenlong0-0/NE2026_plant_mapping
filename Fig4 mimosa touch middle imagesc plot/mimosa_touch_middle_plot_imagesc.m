...
line_ylim = [-100 100];  % Voltage range for line plot, unit: mV

% Imagesc interpolation settings
interp_factor = 100;     % Number of interpolated channels per original channel
trim_head_sec = 6;       % Seconds removed from the beginning
